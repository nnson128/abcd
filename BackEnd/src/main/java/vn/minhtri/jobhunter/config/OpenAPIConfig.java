...
public class OpenAPIConfig {
    ...
    private Contact createContact() {
        return new Contact()
                .email("ads.minhtri@gmail.com")
                .name("Hỏi Dân IT")
                .url("https://minhtri.vn");
    }
    ...
    private Info createApiInfo() {
        return new Info()
                ...
                .termsOfService("https://minhtri.vn/donate")
    ...
    public OpenAPI myOpenAPI() {
        return new OpenAPI()
                ...
                .servers(List.of(
                        ...
                        createServer("https://minhtri.vn", "Server URL in Production environment")))
